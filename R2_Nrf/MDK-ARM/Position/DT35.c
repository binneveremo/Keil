...
//	DT35_Data_Fuse(x,y);
/////////////////////////////////////////简易判断///////////////////////////////////
	if((-dt35.rdt35.its_base_dis + dt35.ldt35.its_base_dis < 8350) && (-dt35.rdt35.its_base_dis + dt35.ldt35.its_base_dis > 7650) && (fabs(site.gyro_pos.with_odo_vy) < 0.8) && (fabs(site.now.y - basket_point.y) < 1000)){
		dt35.ycredible_flag = 1;
	...
	if((site.enc_pos.row_x > 12000) && (dt35.bdt35.its_base_dis < 4000) && (fabs(site.gyro_pos.with_odo_vx) < 0.8) && (fabs(site.now.x - basket_point.x) < 1000)){
		dt35.xcredible_flag = 1;
