...
//	site.now.x = ladar.x;
//	site.now.y = ladar.y;
	site.now.x = ((dt35.xcredible_flag == 1) && (Near_Point(site.target) == 1))?dt35.x:site.enc_pos.row_x + 400;
	site.now.y = ((dt35.ycredible_flag == 1) && (Near_Point(site.target) == 1))?dt35.y:site.enc_pos.row_y - 375;
